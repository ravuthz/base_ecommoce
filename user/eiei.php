        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index.php"><i class="fa fa-fw fa-user"></i> ช้อมูลส่วนตัว</a>
                    </li>
                    <li>
                        <a href="charts.html"><i class="fa fa-fw fa-bar-chart-o"></i>Products</a>
                    </li>
                    <li>
                        <a href="forms.html"><i class="fa fa-fw fa-edit"></i>Sell Announcement</a>
                    </li>
                    <li>
...
<div class="panel panel-info" style="width:60%;margin-left:auto;margin-right:auto;">
	<div class="panel-heading">กล่องข้อความ</div>
...
<tr>
 ...
 <p align="center">&nbsp;&nbsp;<input name="btnAddUser" id="btnAddUser" value="ลบข้อมูล" class="btn btn-danger" type="submit">
