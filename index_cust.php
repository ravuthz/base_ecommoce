...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div>
                    <a href="pay.php" class="list-group-item active">payment
                    </a>
                    <ul class="list-group">
...
<div class="">
    <a class="btn btn-success" href="view_order.php?action=addToCart&id=<?php echo $row["id"]; ?>">Add to cart</a>
</div>
                  </div>
                  <?php };
                   ?>
  ...
  echo "<a href='index.login.php?page=1'>".'|<'."</a> "; // Goto 1st page

  for ($i=1; $i<=$total_pages; $i++) {
              echo "<a href='index.login.php?page=".$i."'>".$i."</a> ";
  };
