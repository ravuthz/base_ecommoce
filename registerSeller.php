...
if (isset($_POST['submit'])){
	...
	if ($pass2==$pass1){
		$pass2=md5($pass1);
		$sql="insert into memberrigester (ID, Name, genda, Address, Email, telephone, city, district, poststation, Username, password2,status ) values ('$id','$name','$genda','$address','$email','$tel','$city', '$district','$post','$username', '$pass2','2')";
